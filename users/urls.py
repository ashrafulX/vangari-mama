...
from users.views import  sign_up, Sign_in , activate_user ,ProfileView , ChangePassword ,CustomPasswordView
...
urlpatterns = [
    ...
    path('reset-password/',CustomPasswordView.as_view(),name='password_reset'),
]
